...
- Переход в TCPCHAT
###### TCPCHAT:
В сетевой чат можно войти только после регистрации и входа под этими данными. Реализована структура клиент - сервер.
Первый процесс, запущенный на одном узле становится сервером. Второй процесс становится клиентом. Они могут общаться друг с другом по очереди.
